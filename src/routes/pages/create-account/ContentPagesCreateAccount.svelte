...
<div class="flex min-h-screen items-center bg-gray-50 p-6 dark:bg-gray-900">
	<div
		class="mx-auto h-full max-w-4xl flex-1 overflow-hidden rounded-lg bg-white shadow-xl dark:bg-gray-800"
	>
				...
				<div class="w-full">
					...
					<div class="mt-6 flex text-sm">
						<label class="flex items-center dark:text-gray-400">
							<input
								type="checkbox"
								class="form-checkbox text-purple-600 focus:border-purple-400 focus:outline-none focus:ring-[3px] focus:ring-purple-200 dark:focus:ring-gray-500"
							/>
							<span class="ml-2">
								I agree to the
					...
					<button
						class="flex w-full items-center justify-center rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 hover:border-gray-500 focus:border-gray-500 focus:outline-none focus:ring-gray-500 active:bg-transparent active:text-gray-500 dark:text-gray-400"
					>
						<svg class="mr-2 h-4 w-4" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor">
							<path
					...
					<button
						class="mt-4 flex w-full items-center justify-center rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 hover:border-gray-500 focus:border-gray-500 focus:outline-none focus:ring-gray-500 active:bg-transparent active:text-gray-500 dark:text-gray-400"
					>
						<svg class="mr-2 h-4 w-4" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor">
							<path
